...
This project supports statements such as:

> Observed local clustering of oxidative stress-associated residues exceeded randomized sequence expectations in selected proteins.

It does not support statements such as:

> This residue is oxidized.

or:

> This sequence region is biochemically reactive.

Any such claims would require orthogonal evidence from structural biology, redox proteomics, targeted mutagenesis, mass spectrometry, or biochemical assays.
